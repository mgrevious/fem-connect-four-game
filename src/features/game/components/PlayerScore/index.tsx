...
const PlayerScore: React.FC<Props> = ({ player, positionClass, className }) => {
  ...
  return (
    <div
      ...
      } flex flex-col sm:flex-row lg:flex-col items-center bg-white rounded-[20px] py-3 sm:px-[45px] lg:px-0 lg:pt-10 lg:pb-[17px] w-[142px] sm:w-[271px] lg:w-[148px] relative`}
    >
